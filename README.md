...
* `Kaggle_Submission.ipynb`: it's the notebook that reproduces predictions of our best performing model and lead us to a score of 2.99 on the public leaderboard https://www.kaggle.com/c/altegrad-2020/leaderboard.
